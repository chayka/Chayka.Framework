...
### $commentsCacheById
    ...
    protected mixed $commentsCacheById = array()
...
### $commentsCacheByPostId
    ...
    protected mixed $commentsCacheByPostId = array()
